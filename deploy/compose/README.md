...
- Default `BUZZ_IMAGE` tracks `ghcr.io/chesapeakedev/buzz:main` for early
  testing. Pin it to `ghcr.io/chesapeakedev/buzz:sha-<7>` or a semver release
  tag for production once available.
